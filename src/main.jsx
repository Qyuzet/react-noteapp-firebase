...
class App extends React.Component {
  ...
  async componentDidMount() {
    try {
      ...
      this.showAlert("Failed to load tasks", "alert-error");
    }
  }
  ...
  async handleSubmit(e) {
    ...
    try {
      if (this.state.editingTaskId !== null) {
        ...
        const taskRef = doc(db, "tasks", this.state.editingTaskId);
        ...
        this.setState((prevState) => ({
          data: [...prevState.data, { id: docRef.id, ...newTask }],
          input: "",
        }));
      ...
      this.showAlert("Failed to save task", "alert-error");
    }
  }
  ...
  async handleDelete(id) {
    try {
      ...
      this.showAlert("Failed to delete task", "alert-error");
    }
  }
